...
export default class GroupRide extends Component {
    ...
    componentDidMount() {
        // Helps screen reader understand to only read what's open in Modal
    ...
    // Handle who is to be invited when button is clicked on
    ...
    // Get a list of friends who are not already attending the bike ride
    checkFriends = () => {
    ...
    // Invite user's friends who have been selected
    inviteFriends = () => {
        let config = {
            method: "PUT",
    ...
    // Check to see if user is a part of the group ride
    checkJoined() {
    ...
    // Allows user to join or leave group
    joinLeave = () => {
